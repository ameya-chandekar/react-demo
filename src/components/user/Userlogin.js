    ...
    render() {
        return (
            ...
            <div><label for="name">Email</label>
                <input type="text" className="form-control" id="" placeholder="enter Email id" onChange={e => {
                        this.setState({
            ...
            <div>
                ...
                <input type="text" className="form-control" id="" placeholder="enter password" onChange={e => {
                        this.setState({
